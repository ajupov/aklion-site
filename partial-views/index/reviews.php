                ...
                <div id="al-reviews-inner" class="row">
                    <?
                        ...
                        foreach ($callouts as $callout)
                        {
                            if($counter < 3)
                            {
                                echo $templater->render('/partial-views/callout/callout-visible.php', (array)$callout);
                            }
                            else
                            {
                                echo $templater->render('/partial-views/callout/callout-hidden.php', (array)$callout);
                            }
