<div class="navbar-fixed">
    <nav>
        <div class="center-align hide-on-med-and-up">
            <div class="row">
            <div class="col s1">
                <? include('/partial-views/hamburger/hamburger-menu.php'); ?>
            </div>
            <div class="col s10">
                <a href="/">
                    <img src="/assets/images/logos/logo-small.png" id="al-logo-small" alt="Аклион">
                </a>
            </div>
        </div>
        </div>
        <div id="al-nav-1" class="hide-on-small-and-down">
            <div class="container">
                <a href="/">
                    <img src="/assets/images/logos/logo.png" id="al-logo" alt="Аклион">
                </a>
